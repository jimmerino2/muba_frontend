...
const { data, loading, error, refresh } = useAsync(() => tpaApi.getPayments(auth.orgId!))
...
<template>
  <div>
    <PageHeader
      title="Payments"
      subtitle="Settlements for the claims you administer. The insurer funds them; you may initiate or retry on its behalf."
    />
