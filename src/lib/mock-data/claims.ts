...
export const claims: Claim[] = [
  /* ------------------------------------------------ clm_001 — closed (paid out) */
  {
    ...
    timeline: [
      ...
      ev('auto_approved', 'Auto-approval threshold met', 'Score 93 ≥ 85 and RM12,400 ≤ RM15,000 limit — no human review required.', 'RICE policy engine', 'system', ago(46)),
      ev('approved', 'Approved for settlement', 'RM11,900 payable after the RM500 deductible.', 'RICE policy engine', 'system', ago(46)),
  ...
  /* ------------- clm_002 — pending_review, LOW score (core demo contrast) ★ */
  {
    ...
    timeline: [
      ...
      ev('pending_review', 'Routed to human review', 'Score 58 is below the policy threshold of 82. Assigned to the medical assessment queue.', 'RICE policy engine', 'system', ago(10, 1)),
  ...
  /* ------------------------------- clm_003 — auto-approved, awaiting settlement */
  {
    ...
    timeline: [
      ...
      ev('auto_approved', 'Auto-approval threshold met', 'Score 91 ≥ 88 and RM3,850 ≤ RM5,000 limit — no human review required.', 'RICE policy engine', 'system', ago(6, 3)),
    ],
    decisionExplanation: null,
  },
  ...
  /* --------------- clm_006 — human-approved after review, payment outstanding */
  {
    ...
    timeline: [
      ...
      ev('pending_review', 'Routed to human review', 'Score 81 is below the policy threshold of 85. Assigned to the medical assessment queue.', 'RICE policy engine', 'system', ago(19, 4)),
  ...
  /* -------------------------------------- clm_007 — rejected after human review */
  {
    ...
    timeline: [
      ...
      ev('pending_review', 'Routed to human review', 'Score 34 is far below the policy threshold of 82. Flagged as a possible coverage exclusion.', 'RICE policy engine', 'system', ago(33, 5)),
  ...
  /* --------------------------------- clm_008 — auto-approved and paid on Sui */
  {
    ...
    timeline: [
      ...
      ev('auto_approved', 'Auto-approval threshold met', 'Score 96 ≥ 90 and RM27,500 ≤ RM30,000 limit — part of a pre-authorised treatment plan.', 'RICE policy engine', 'system', ago(60, 2)),
      ev('approved', 'Approved for settlement', 'RM27,000 payable after the RM500 deductible.', 'RICE policy engine', 'system', ago(60, 2)),
  ...
  /* ------------------------------------------- clm_009 — closed, historical */
  {
    ...
    timeline: [
      ...
      ev('auto_approved', 'Auto-approval threshold met', 'Score 92 ≥ 88 and RM4,750 ≤ RM5,000 limit — no human review required.', 'RICE policy engine', 'system', ago(87, 3)),
      ev('approved', 'Approved for settlement', 'RM4,250 payable after the RM500 deductible.', 'RICE policy engine', 'system', ago(87, 3)),
  ...
  /* ------- clm_011 — HIGH score but routed on amount alone (core contrast) ★ */
  {
    ...
    timeline: [
      ...
      ev('pending_review', 'Routed to human review', 'Score 94 clears the threshold of 82, but RM46,800 exceeds the RM25,000 auto-approval limit — mandatory assessor sign-off.', 'RICE policy engine', 'system', ago(12, 3)),
  ...
  /* ---------------------- clm_012 — auto-approved, settlement failed on retry */
  {
    ...
    timeline: [
      ...
      ev('auto_approved', 'Auto-approval threshold met', 'Score 95 ≥ 90 and RM2,660 ≤ RM30,000 limit — no human review required.', 'RICE policy engine', 'system', ago(8, 4)),
    ],
    decisionExplanation: null,
  },
  ...
  /* ------------------- clm_013 — borderline score, awaiting the demo patient's insurer */
  {
    ...
    timeline: [
      ...
      ev('pending_review', 'Routed to human review', 'Score 74 is below the policy threshold of 85. Assigned to the medical assessment queue.', 'RICE policy engine', 'system', ago(12, 5)),
    ],
    decisionExplanation: null,
  },
]
