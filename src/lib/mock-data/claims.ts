...
const GE = { insurerId: 'org_greateastern', insurerName: 'Great Eastern Takaful' }
const ETQ = { insurerId: 'org_etiqa', insurerName: 'Etiqa Insurance Berhad' }
...
export const claims: Claim[] = [
  /* ------------------------------------------------ clm_001 — closed (paid out) */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 3 supporting documents.', 'Dr. Farah Iskandar', 'hospital', ago(46, 1)),
  ...
  /* ------------- clm_002 — pending_review, LOW score (core demo contrast) ★ */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 2 supporting documents.', 'Dr. Suresh Menon', 'hospital', ago(10, 2)),
  ...
  /* ------------------------------- clm_003 — auto-approved, awaiting settlement */
  {
    ...
    decision: {
      outcome: 'approved',
      reason:
        'Cleared automatically: Truth Score 91 exceeds the policy threshold of 88 and RM3,850 is within the RM5,000 auto-approval limit. RM250 deductible applied.',
      reviewerName: 'WayFare auto-approval',
      decidedAt: ago(6),
      approvedAmount: 3_600,
    },
    paymentId: 'pay_002',
    timeline: [
      ev('created', 'Claim drafted', 'Raised from medical record MR-2026-1085.', 'Nurul Izzati (Claims Officer)', 'hospital', ago(6, 4)),
      ev('submitted', 'Submitted to insurer', 'Sent to Etiqa Insurance Berhad with 1 supporting document.', 'Nurul Izzati (Claims Officer)', 'hospital', ago(6, 3)),
  ...
  /* --------------- clm_006 — human-approved after review, payment outstanding */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 2 supporting documents.', 'Dr. Lee Kar Wai', 'hospital', ago(19, 4)),
  ...
  /* -------------------------------------- clm_007 — rejected after human review */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 1 supporting document.', 'Nurul Izzati (Claims Officer)', 'hospital', ago(33, 5)),
  ...
  /* --------------------------------- clm_008 — auto-approved and paid on Sui */
  {
    ...
    decision: {
      outcome: 'approved',
      reason:
        'Cleared automatically: Truth Score 96 exceeds the policy threshold of 90 and RM27,500 is within the RM30,000 auto-approval limit. RM2,000 deductible applied.',
      reviewerName: 'WayFare auto-approval',
      decidedAt: ago(60),
      approvedAmount: 25_500,
    },
    paymentId: 'pay_004',
    timeline: [
      ev('created', 'Claim drafted', 'Raised from medical record MR-2026-1029.', 'Dr. Hafiz Rahim', 'hospital', ago(60, 3)),
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 3 supporting documents.', 'Dr. Hafiz Rahim', 'hospital', ago(60, 2)),
  ...
  /* ------------------------------------------- clm_009 — closed, historical */
  {
    ...
    decision: {
      outcome: 'approved',
      reason:
        'Cleared automatically: Truth Score 92 exceeds the policy threshold of 88 and RM4,750 is within the RM5,000 auto-approval limit. RM250 deductible applied.',
      reviewerName: 'WayFare auto-approval',
      decidedAt: ago(87),
      approvedAmount: 4_500,
    },
    paymentId: 'pay_005',
    timeline: [
      ev('created', 'Claim drafted', 'Raised from medical record MR-2026-0998.', 'Nurul Izzati (Claims Officer)', 'hospital', ago(87, 4)),
      ev('submitted', 'Submitted to insurer', 'Sent to Etiqa Insurance Berhad with 1 supporting document.', 'Nurul Izzati (Claims Officer)', 'hospital', ago(87, 3)),
      ...
      ev('approved', 'Approved for settlement', 'RM4,500 payable after the RM250 deductible.', 'WayFare policy engine', 'system', ago(87, 3)),
  ...
  /* ------- clm_011 — HIGH score but routed on amount alone (core contrast) ★ */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 3 supporting documents.', 'Dr. Hafiz Rahim', 'hospital', ago(12, 3)),
  ...
  /* ---------------------- clm_012 — auto-approved, settlement failed on retry */
  {
    ...
    decision: {
      outcome: 'approved',
      reason:
        'Cleared automatically: Truth Score 95 exceeds the policy threshold of 90 and RM2,660 is within the RM30,000 auto-approval limit. RM2,000 deductible applied.',
      reviewerName: 'WayFare auto-approval',
      decidedAt: ago(8),
      approvedAmount: 660,
    },
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 2 supporting documents.', 'Dr. Priya Raman', 'hospital', ago(8, 4)),
  ...
  /* ------------------- clm_013 — borderline score, awaiting the demo patient's insurer */
  {
    ...
    timeline: [
      ...
      ev('submitted', 'Submitted to insurer', 'Sent to Great Eastern Takaful with 2 supporting documents.', 'Dr. Priya Raman', 'hospital', ago(12, 5)),
